...
1. [Создание книги](https://bookstore.demoqa.com/swagger/#/BookStore/BookStoreV1BooksPost)
2. [Обновление книги](https://bookstore.demoqa.com/swagger/#/BookStore/BookStoreV1BooksByISBNPut)
3. [Получении информации о книге](https://bookstore.demoqa.com/swagger/#/BookStore/BookStoreV1BookGet)
4. [Удаление книги](https://bookstore.demoqa.com/swagger/#/BookStore/BookStoreV1BookDelete)
...
**Вариант 2:** Напишите 10 апи-тестов на любой сервис имеющий публичное АПИ, можно использовать АПИ рабочего проекта.
