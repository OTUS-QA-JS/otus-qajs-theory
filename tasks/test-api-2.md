# API тесты с использованием сервисов
...
В этом задании есть два варианта, выберете, тот, что вам больше подходит. В любом случае при выполнении ДЗ обязательно использовать сервис(ы), а так же файлы конфигурации.

**Вариант 1:**
Напишите API тесты на следующие апи ручки (api endpoints)
1. [Авторизация](https://bookstore.demoqa.com/swagger/#/Account/AccountV1AuthorizedPostt)
2. [Удаление пользователя](https://bookstore.demoqa.com/swagger/#/Account/AccountV1UserByUserIdDelete)
3. [Получение информации о пользователе](https://bookstore.demoqa.com/swagger/#/Account/AccountV1UserByUserIdGet)
...
framework/services // сервисы, обёртка запросов к API
...
---
## Критерии оценивания
В АПИ тестах использованы сервисы.